...
Příkladem může být kulička na břitu. Do stejné katergorie patří například rovnice pro popis počasí. Důsledkem je praktická nemožnost 
...
Globální chyba tedy zahrnuje ochylky ze všech časových kroků.
...
Vidíme, že $e_i$ klesá lineárně v závislosti na $h$, jde tedy o kovergentní metodu prvního řádu. 
...
Nechť $\vc y$ je řešení počáteční úlohy s pravou stranou  $\vc f$ splňující předpoklady Picardovy věty \ref{thm::Picard} s Lischitzovskou konstantou $L$.
...
Doposud jsme analyzovali pouze chyby způsobeneé diskretizací diferenciální rovnice. Pro Eulerovu metodu dostáváme lineární pokles globální chyby z závislosti na 
...
Nechť je pravá strana $\vc f$ Lischitzovská s konstantou $L$ a
...
\begin{definition}
 Jednokroková numerická metoda je \df{stabilní} pokud existují kladné konstatny $\hat h$, $k$ takové, že pro numerické řešení $\vc y_i$ úlohy s počáteční podmínkou $\vc y_0$ 
...
Absolutní stabilita se obvykle vyšetřuje na obecné skalární lineární rovnici:
\begin{equation}
