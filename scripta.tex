...
\[
   y' = f(t,y), t>0, y(0)=y_0.
\]
Z předepsané počáteční podmínky můžeme spočítat \uv{polohu} a \uv{rychlost} v počátečním čase, $y(0) = y_0$, $y'(0) = f(0, y_0)$. 
...
\begin{definition}
 Metoda se nazývá \uv{absolutně stabilní} pro časový krok $h$ a danou ODR, pokud změna počáteční podmínky $y_0$ o $\delta$ vyvolá změnu numerického řešení v dalších 
